...
- If the number is genuinely impossible to anchor (no inferable reference class at all), return `{"insufficient_context": true, "verdict": "one short sentence saying why"}` instead.
